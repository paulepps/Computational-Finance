...
#
# Test H0: rho_ij = 0 vs. H1: rho_ij /= 0
#
...
#
# Test H0: returns are normal vs. H1: returns are not normal
#
...
#
# 24 month rolling estimates of mu and sd
#
...
#
# Evaluate bias and SE formulas using Monte Carlo
#
...
# 
# compute MC estimates of bias and SE
#
...
#
# bootstrapping SE for mean, variance, sd and correlation
#
